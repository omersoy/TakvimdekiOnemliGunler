...
class DialogAdaptorStudent extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        tvTitle.setText("Başlık : "+alCustom.get(position).getTitles());
        tvSubject.setText("Konu : "+alCustom.get(position).getSubjects());
        tvDuedate.setText("Due Date : "+alCustom.get(position).getDuedates());
        tvDescription.setText("Açıklama : "+alCustom.get(position).getDescripts());
